    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <main className="flex-1 p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold">Laporan Nilai</h1>
          {/* Tombol Tambah Laporan Nilai */}
          <Link
            to="/report-grades/add" // Arahkan ke halaman tambah laporan nilai
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1: Total Laporan Nilai */}
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg shadow-lg">
            <h2 className="text-lg font-semibold">Total Laporan Nilai</h2>
          ...
          {/* Card 2: Laporan Nilai Terbaru */}
          <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-lg shadow-lg">
            <h2 className="text-lg font-semibold">Laporan Nilai Terbaru</h2>
            <p className="mt-2 text-4xl font-bold">John Doe</p>
            <div className="mt-4 text-sm text-green-200">
              New report submitted
            </div>
          </div>

          {/* Card 3: Laporan Nilai Terpopuler */}
          <div className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white p-6 rounded-lg shadow-lg">
            <h2 className="text-lg font-semibold">Laporan Nilai Terpopuler</h2>
            <p className="mt-2 text-4xl font-bold">Matematika</p>
            <div className="mt-4 text-sm text-yellow-200">
              Most viewed this semester
            </div>
          </div>
        </div>

        {/* Table Section: Daftar Laporan Nilai */}
        <div className="mt-8 bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-800">
              Daftar Laporan Nilai
            </h3>
          </div>
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm text-left text-gray-600">
              ...
              <tbody>
                ...
                {/* Tambahkan laporan nilai lainnya sesuai kebutuhan */}
              </tbody>
            </table>
          </div>
        </div>
